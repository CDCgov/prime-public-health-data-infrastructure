...
def find_patient_resource(bundle: dict) -> dict:
    """Grab a patient resource out of the bundle, and return a reference"""
...
def transform_bundle(client: us_street.Client, bundle: dict) -> dict:
    """Standardize name and phone, geocode the address"""

    resource = find_patient_resource(bundle)
    if not resource:
        return None
