...
if __name__ == "__main__":
    #import json
    #bundle = json.load(open(r"/Users/danielpaseltiner/Skylight/real-VA-data/00066837-0c33-4526-9ccb-ca750b94794d.fhir"))
    #breakpoint()
    ...
    'resource': {'resourceType': 'Patient', 
                ...
                'name': [{'family': 'FOWLKES', 'given': ['CHERYL'], 'use': 'official'}], 
                'birthDate': '1960-07-28', 
                'gender': 'female', 
                'address': [{'line': ['4903 Falcon Creek Way'], 'city': 'Hampton', 'state': 'VA', 'postalCode': '23666', 'use': 'home', 'extension': [{'url': 'http://hl7.org/fhir/StructureDefinition/geolocation', 'extension': [{'url': 'latitude', 'valueDecimal': 37.09339}, {'url': 'longitude', 'valueDecimal': -76.39775}]}]}], 
