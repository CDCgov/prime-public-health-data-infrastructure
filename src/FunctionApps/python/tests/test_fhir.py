...
@mock.patch("requests.post")
@mock.patch.dict("os.environ", TEST_ENV)
def test_fhir_resource_put(mock_post, mock_put):
    ...
    fhir.upload_bundle_to_fhir_server(fhir_json_req)
...
@mock.patch("requests.post")
@mock.patch.dict("os.environ", TEST_ENV)
def test_fhir_submit_bundle(mock_post):
    ...
    fhir.upload_bundle_to_fhir_server(fhir_json_orig)
