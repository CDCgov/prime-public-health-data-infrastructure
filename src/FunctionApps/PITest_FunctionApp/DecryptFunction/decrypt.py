...
def main_with_overload(
    ...
    if raw_body == "":
        return func.HttpResponse(
            "Please pass the encrypted message in the body of the request",
            status_code=400,
        )
    ...
    try:
        sc = PHDIStorageClient(settings.storage_client_settings)
    except TypeError:
        return func.HttpResponse("Failed to create storage client", status_code=500)
